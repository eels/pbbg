...
Aethelm ("us", "we", or "our") operates the [{process.env.APP_WEB_HOST}](/) website
(the "Service").
...
Conditions, accessible from [{process.env.APP_WEB_HOST}/terms](/terms).
...
Aethelm will take all steps reasonably necessary to ensure that your data is treated securely and
...
- **Google Analytics**
  ...
  web page: [https://policies.google.com/privacy](https://policies.google.com/privacy)
